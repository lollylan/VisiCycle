...
if __name__ == "__main__":
    ...
    try:
        ...
        print("  Wahrscheinlich laeuft VisiCycle bereits im")
        print("  Hintergrund oder der Port 8555 ist belegt.")
        print("  (Fehlerdetail: " + str(e) + ")")
        print("!" * 50 + "\n")
        input("  Druecken Sie die Eingabetaste (Enter), um das Fenster zu schliessen...")
